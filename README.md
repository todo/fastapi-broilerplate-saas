...
- 🎯 Entry points to execute your program using `python -m <fastapi_broilerplate_saas>` or `$ fastapi_broilerplate_saas` with basic CLI argument parsing.
...
---
# fastapi_broilerplate_saas

[![codecov](https://codecov.io/gh/todo/fastapi-broilerplate-saas/branch/main/graph/badge.svg?token=fastapi-broilerplate-saas_token_here)](https://codecov.io/gh/todo/fastapi-broilerplate-saas)
[![CI](https://github.com/todo/fastapi-broilerplate-saas/actions/workflows/main.yml/badge.svg)](https://github.com/todo/fastapi-broilerplate-saas/actions/workflows/main.yml)

Awesome fastapi_broilerplate_saas created by todo

## Install

from source
```bash
git clone https://github.com/todo/fastapi-broilerplate-saas fastapi_broilerplate_saas
cd fastapi_broilerplate_saas
make install
```
...
```bash
pip install fastapi_broilerplate_saas
```

## Executing

```bash
$ fastapi_broilerplate_saas run --port 8080
```

or

```bash
python -m fastapi_broilerplate_saas run --port 8080
```

or

```bash
$ uvicorn fastapi_broilerplate_saas:app
```

## CLI

```bash
❯ fastapi_broilerplate_saas --help
Usage: fastapi_broilerplate_saas [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ fastapi_broilerplate_saas create-user --help
Usage: fastapi_broilerplate_saas create-user [OPTIONS] USERNAME PASSWORD
...
```bash
fastapi_broilerplate_saas create-user admin admin --superuser
```
...
```bash
❯ fastapi_broilerplate_saas shell       
...
Run with `fastapi_broilerplate_saas run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `fastapi_broilerplate_saas create-user`.
...
-----------------------------------------------------
fastapi_broilerplate_saas/__init__.py              4      0   100%
fastapi_broilerplate_saas/app.py                  16      1    94%
fastapi_broilerplate_saas/cli.py                  21      0   100%
fastapi_broilerplate_saas/config.py                5      0   100%
fastapi_broilerplate_saas/db.py                   10      0   100%
fastapi_broilerplate_saas/models/__init__.py       0      0   100%
fastapi_broilerplate_saas/models/content.py       47      1    98%
fastapi_broilerplate_saas/routes/__init__.py      11      0   100%
fastapi_broilerplate_saas/routes/content.py       52     25    52%
fastapi_broilerplate_saas/routes/security.py      15      1    93%
fastapi_broilerplate_saas/routes/user.py          52     26    50%
fastapi_broilerplate_saas/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in fastapi_broilerplate_saas/default.toml.
