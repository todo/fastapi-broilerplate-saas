...
# WARNING: Ensure imports from `fastapi_broilerplate_saas` comes after this line
from fastapi_broilerplate_saas import app, settings, db  # noqa
from fastapi_broilerplate_saas.cli import create_user, cli  # noqa
