...
├── fastapi_broilerplate_saas             # The main python package for the project
...
e.g: `cat fastapi_broilerplate_saas/VERSION` will get the project version without harming
